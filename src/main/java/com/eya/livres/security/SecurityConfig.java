...
public class SecurityConfig {
	...
	.requestMatchers("/showCreate","/saveLivre").hasAnyAuthority("ADMIN","AGENT")
	.requestMatchers("/modifierLivre","/supprimerLivre").hasAnyAuthority("ADMIN")
	.requestMatchers("/ListeLivres").hasAnyAuthority("ADMIN","AGENT","USER")
	 ...
	 * UserDetails userEya = User .withUsername("eya")
	 * .password(passwordEncoder.encode("123")) .authorities("AGENT","USER")
	 * .build(); UserDetails user1 = User .withUsername("user1")
